          ...
          <div className="Box-Perfil">
            <div className="Perfil">
              <div className="Descripcion">
                ...
                <p>
                  Soy un desarrollador Front end. Me apasiona crear soluciones
                  web que combinen funcionalidad, estética y usabilidad.
                </p>
                <p>
                  Mi trabajo refleja mi esencia y mi calidad. Soy una persona
                  creativa y recursiva, que siempre busca nuevas formas de
                  resolver problemas y mejorar los procesos.
                </p>
                <p>
                  Me aseguro de que cada solución sea personalizada y adaptada a
                  tus necesidades. Si estás buscando a alguien comprometido,
                  creativo y confiable, puedo ayudarte a hacer realidad tus
                  ideas. Si tienes alguna pregunta o necesitas más información,
                  no dudes en contactarme.
                </p>
                <div className="GitHub">
                  <p>
                    Te invito a que visites mi perfil en GitHb, para ver mas
                    sobre mi y los proyectos que he realizado
                  </p>
                  <Link
          ...
          <div className="Metodologia">
            ...
            <div className="Cards">
              <div className="Card" data-content="1">
                ...
                />
                <p>
                  Analizo el objetivo, el público y las necesidades de tu sitio
                  web. Te propongo las funcionalidades y características que
              ...
              <div className="Card" data-content="2">
                ...
                />
                <p>
                  Creo la apariencia y la interfaz de tu sitio web, pensando en
                  la usabilidad, la accesibilidad y la experiencia de usuario.
                </p>
              </div>
