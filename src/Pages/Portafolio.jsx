      ...
      <div className="Proyectos">
        ...
        <div className="ProyectosIniciales">
          <div className="Box-Proyectos">
            <div className="Proyecto">
              ...
              <Link target="_blanck" to="https://danilett0.github.io/WhaterApp/">
                VER SITIO WEB
              </Link>
            </div>
            ...
            <div className="Proyecto">
              ...
              <Link target="_blanck" to="https://danilett0.github.io/calculadoraReact/">
                VER SITIO WEB
              </Link>
            </div>
            ...
            <div className="Proyecto">
              ...
              <Link target="_blanck" to="https://danilett0.github.io/RandomGif/">
                VER SITIO WEB
              </Link>
            </div>
          </div>
        ...
        <div className="Box-Proyectos">
          <div className="Proyecto">
            ...
            <Link target="_blanck" to="https://danilett0.github.io/Landing-Page-Fyllo/">
              VER SITIO WEB
            </Link>
          </div>
          <div className="Proyecto">
            ...
            <Link target="_blanck" to="https://danilett0.github.io/Pagina-Web-Finca-Raiz/">
              VER SITIO WEB
            </Link>
          </div>
          <div className="Proyecto">
            ...
            <Link target="_blanck" to="https://danilett0.github.io/Landing-Page-Bokmark/">
              VER SITIO WEB
            </Link>
          </div>
        </div>
          ...
          {showProyectos && (
            <div className="Box-Proyectos">
              <div className="Proyecto">
                ...
                <Link target="_blanck" to="https://danilett0.github.io/Landing-Page-Psicologa/">
                  VER SITIO WEB
                </Link>
              </div>
              <div className="Proyecto">
                ...
                <Link target="_blanck" to="https://danilett0.github.io/Landing-Page-Lifemiles/">
                  VER SITIO WEB
                </Link>
              </div>
              <div className="Proyecto">
                ...
                <Link target="_blanck" to="https://danilett0.github.io/Landing-Page-Shortli/">
                  VER SITIO WEB
                </Link>
              </div>
            </div>
      ...
      <div className="OtrosProyectos">
        <div>
          <p>
            ...
            <Link target="_blanck" to="https://github.com/Danilett0">
              Ver Repositorio
            </Link>
          </p>
          <img
