        ...
        <main>
          <div className="Encabezado">
            ...
            <p>
              ...
              Daniletto ofrece soluciones creativas y eficientes para proyectos
              web de todo tipo, desde páginas personales hasta aplicaciones
              complejas.
            </p>
          ...
          <div className="Beneficios">
            ...
            <div className="Cards">
              ...
              <div className="Card">
                ...
                />
                <p>
                  Ofrezco precios competitivos para que puedas obtener un sitio
                  web de muy alta calidad sin gastar una fortuna.
                </p>
              </div>
              <div className="Card">
          ...
          <div className="Cotizacion">
            ...
            <p>
              ...
              permite calcular el precio de tu página web según tus preferencias
              y necesidades. Solo tienes que responder unas sencillas preguntas
              y en minutos obtendrás un presupuesto personalizado y sin
              compromiso.
            </p>
