        ...
        <div className="Articles">
          <div className="Article">
            ...
            <div className="BodyCard">
              ...
              <p>
                ¿Te gustaría crear imágenes impresionantes sin necesidad de ser
                un experto en diseño gráfico? En este artículo te enseñamos cómo
          ...
          <div className="Article">
            ...
            <div className="BodyCard">
              <h3>
                Todo lo que necesitas saber sobre el diseño UX y cómo aplicarlo
                a tu página web
              </h3>
              <p>
          ...
          <div className="Article">
            ...
            <div className="BodyCard">
              ...
              <p>
                ...
                gratuita que te ayuda a analizar y mejorar tu web, a detectar y
                solucionar errores, a medir el tráfico y el comportamiento de
                los usuarios.
              </p>
              <Link
                className="Button Red"
