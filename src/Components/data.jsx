export const preguntasFrecuentes = [
  ...
  },
  {
    ...
    respuesta:
      "El tiempo de entrega estimado depende de varios factores, como la complejidad del proyecto, el número de páginas, las funcionalidades requeridas y las revisiones solicitadas por el cliente. para ello puedes hacer una cotizacion personalizada con los medios de contacto habilitados.",
  },
  {
    id: 4,
...
export const ListaHabilidades = [
  ...
  {id: 2, habilidad: "Moficaciones, ajustes o nuevas funcionalidades para tu web."},
  {id: 3, habilidad: "Creacion de contenido (imagen, video, texto) para tu sitio web."},
